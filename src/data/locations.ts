...
export const locations: Location[] = [
  ...
  },
  {
    ...
    featured: false,
    description:
      "Atlas Mitigation provides professional restoration services to Lawrenceville, Georgia, the county seat of Gwinnett County. As one of the fastest-growing counties in the nation, Gwinnett features a diverse mix of residential neighborhoods, commercial centers, and mixed-use developments. Our certified technicians respond quickly to water, fire, and mold emergencies throughout Lawrenceville and surrounding Gwinnett County communities, delivering expert restoration that protects your property and investment.",
    neighborhoods: [
    ...
    zipCodes: ["30043", "30044", "30045", "30046", "30049"],
    responseTime: "50 minutes",
    projectsCompleted: 45,
    metaTitle: "Water & Fire Damage Restoration Lawrenceville GA | Gwinnett County",
    metaDescription:
      "Professional water and fire damage restoration in Lawrenceville & Gwinnett County, GA. 24/7 emergency response. Certified technicians. Call (770) 588-1119.",
  },
  {
    slug: "sandy-springs",
    city: "Sandy Springs",
